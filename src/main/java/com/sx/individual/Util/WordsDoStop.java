...
public class WordsDoStop {
    ...
    public static void directoryTxt(String stopwords, String path, @ShellOption(defaultValue = "-1")int n){
    ...
    public static void directory(String stopwords, String path, @ShellOption(defaultValue = "-1")int n){
        File file = new File(path);
